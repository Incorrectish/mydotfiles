...
return {
  ...
  config = function()
    ...
    --     s = {dap.continue, 'Debug: Start'},
    --     t = {dap.toggle_breakpoint, "Debug: Toggle Breakpoint"},
    --     o = {dap.step_over, 'Debug: Step Over'},
    --     u = {dap.step_out, 'Debug: Step Out'},
    --     U = {require'dapui'.toggle({reset = true}), "Debug: Toggle UI"},
    --
    ...
    vim.keymap.set('n', '<leader>dr', dapui.repl_toggle, { desc = 'Debug: Toggle Repl' })
