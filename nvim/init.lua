...
require('telescope').setup {
  ...
  -- Customize vimgrep_arguments to exclude node_modules
  vimgrep_arguments = {
    'rg',
    '--color=never',
    '--no-heading',
...
vim.defer_fn(function()
  ...
  -- Configure nvim-treesitter-textobjects (new API)
...
vim.api.nvim_set_hl(0, 'leap-highlight', { fg = "#ff0000", bg = "#00FF00", sp = "#00FF00", })
vim.api.nvim_set_hl(0, 'hl-LeapMatch', { fg = "#ff0000", bg = "#00FF00", sp = "#00FF00", })
vim.lsp.inlay_hint.enable()


-- This is an autocommand that disables the formatexpr for .md, .org, .txt, and no extension files. This is because
-- gq doesn't work when the file has conform formatter set
